...
print("\nThis is the common user following between Node_a and Node_b__________________________\n")
print(common_users_following(Node_a,Node_b))
print("\nThis the trend analisis by topic to Node_a__________________________\n")
